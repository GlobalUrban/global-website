...
const projects2 = [
    ...
    'Land and Water Conservation Fund (LWCF) <br/> <span>Funding Agency: California Department of Parks and Recreation</span> </br><span style="font-size:24px; color: #F17838;">Requested Amount: $6 million</span>',
    // Slide 4 // -------------------------------------------------------------------------------------------------------------------------
    'Safe Streets and Roads for All (SS4A) Grant Program <br/> <span>Funding Agency: U.S. Department of Transportation (DOT)</span> </br><span style="font-size:24px; color: #F17838;">Requested Amount: $3.5 million</span>',
    // Slide 5 // -------------------------------------------------------------------------------------------------------------------------
